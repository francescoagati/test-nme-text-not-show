...
class HXCPP_CLASS_ATTRIBUTES  GraphicsRenderer_obj : public hx::Object{
	...
	public:
		...
		static ::openfl::_internal::renderer::opengl::shaders2::Shader prepareShader( ::openfl::_internal::renderer::opengl::utils::GLBucket bucket,::openfl::_internal::renderer::RenderSession renderSession,::openfl::display::DisplayObject object,::lime::utils::Float32Array translationMatrix);
