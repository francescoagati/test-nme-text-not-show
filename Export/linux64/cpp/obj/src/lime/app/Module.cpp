...
Void Module_obj::onMouseMove( Float x,Float y){
{
...
HX_DEFINE_DYNAMIC_FUNC2(Module_obj,onMouseMove,(void))

Void Module_obj::onMouseMoveRelative( Float x,Float y){
{
		HX_STACK_FRAME("lime.app.Module","onMouseMoveRelative",0xcea635e7,"lime.app.Module.onMouseMoveRelative","lime/app/Module.hx",78,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
	}
...
HX_DEFINE_DYNAMIC_FUNC2(Module_obj,onMouseMoveRelative,(void))

Void Module_obj::onMouseUp( Float x,Float y,int button){
{
		HX_STACK_FRAME("lime.app.Module","onMouseUp",0xa7fddec5,"lime.app.Module.onMouseUp","lime/app/Module.hx",87,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
		HX_STACK_ARG(button,"button")
...
{
		HX_STACK_FRAME("lime.app.Module","onMouseWheel",0x15885a71,"lime.app.Module.onMouseWheel","lime/app/Module.hx",95,0x653a538a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("lime.app.Module","onRenderContextLost",0xd88ecae2,"lime.app.Module.onRenderContextLost","lime/app/Module.hx",101,0x653a538a)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("lime.app.Module","onRenderContextRestored",0x4a587554,"lime.app.Module.onRenderContextRestored","lime/app/Module.hx",108,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(context,"context")
	}
return null();
...
Void Module_obj::onTextEdit( ::String text,int start,int length){
{
		HX_STACK_FRAME("lime.app.Module","onTextEdit",0xf80cbad2,"lime.app.Module.onTextEdit","lime/app/Module.hx",117,0x653a538a)
		HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC3(Module_obj,onTextEdit,(void))

Void Module_obj::onTextInput( ::String text){
{
		HX_STACK_FRAME("lime.app.Module","onTextInput",0x67528242,"lime.app.Module.onTextInput","lime/app/Module.hx",124,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(text,"text")
	}
return null();
...
HX_DEFINE_DYNAMIC_FUNC1(Module_obj,onTextInput,(void))

Void Module_obj::onTouchEnd( Float x,Float y,int id){
{
		HX_STACK_FRAME("lime.app.Module","onTouchEnd",0xb20c62d7,"lime.app.Module.onTouchEnd","lime/app/Module.hx",133,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
		HX_STACK_ARG(id,"id")
...
{
		HX_STACK_FRAME("lime.app.Module","onTouchMove",0x1e14a095,"lime.app.Module.onTouchMove","lime/app/Module.hx",142,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
		HX_STACK_ARG(id,"id")
...
{
		HX_STACK_FRAME("lime.app.Module","onTouchStart",0xab9d8a5e,"lime.app.Module.onTouchStart","lime/app/Module.hx",151,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
		HX_STACK_ARG(id,"id")
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowActivate",0xa3ae477e,"lime.app.Module.onWindowActivate","lime/app/Module.hx",157,0x653a538a)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowClose",0x4c406f0d,"lime.app.Module.onWindowClose","lime/app/Module.hx",163,0x653a538a)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowDeactivate",0x1fbe50bf,"lime.app.Module.onWindowDeactivate","lime/app/Module.hx",169,0x653a538a)
		HX_STACK_THIS(this)
	}
return null();
}
...
Void Module_obj::onWindowEnter( ){
{
		HX_STACK_FRAME("lime.app.Module","onWindowEnter",0x7463c46d,"lime.app.Module.onWindowEnter","lime/app/Module.hx",175,0x653a538a)
		HX_STACK_THIS(this)
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC0(Module_obj,onWindowEnter,(void))

Void Module_obj::onWindowFocusIn( ){
{
		HX_STACK_FRAME("lime.app.Module","onWindowFocusIn",0xf8e4dc72,"lime.app.Module.onWindowFocusIn","lime/app/Module.hx",181,0x653a538a)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowFocusOut",0xcf609b61,"lime.app.Module.onWindowFocusOut","lime/app/Module.hx",187,0x653a538a)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowFullscreen",0xdd712ec6,"lime.app.Module.onWindowFullscreen","lime/app/Module.hx",193,0x653a538a)
		HX_STACK_THIS(this)
	}
return null();
}
...
Void Module_obj::onWindowLeave( ){
{
		HX_STACK_FRAME("lime.app.Module","onWindowLeave",0x76308c4c,"lime.app.Module.onWindowLeave","lime/app/Module.hx",199,0x653a538a)
		HX_STACK_THIS(this)
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC0(Module_obj,onWindowLeave,(void))

Void Module_obj::onWindowMinimize( ){
{
		HX_STACK_FRAME("lime.app.Module","onWindowMinimize",0xdf7b6ae9,"lime.app.Module.onWindowMinimize","lime/app/Module.hx",205,0x653a538a)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowMove",0x01388d5c,"lime.app.Module.onWindowMove","lime/app/Module.hx",213,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
	}
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowResize",0x664a6cff,"lime.app.Module.onWindowResize","lime/app/Module.hx",221,0x653a538a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowRestore",0x2211fde3,"lime.app.Module.onWindowRestore","lime/app/Module.hx",224,0x653a538a)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("lime.app.Module","render",0xc490e692,"lime.app.Module.render","lime/app/Module.hx",231,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(context,"context")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","update",0x466d0145,"lime.app.Module.update","lime/app/Module.hx",238,0x653a538a)
		HX_STACK_THIS(this)
