...
class HXCPP_CLASS_ATTRIBUTES  Context3D_obj : public hx::Object{
	...
	public:
		...
		::openfl::geom::Rectangle scrollRect;
		::lime::graphics::opengl::GLRenderbuffer stencilbuffer;
		...
		virtual Void setGLSLProgramConstantsFromByteArray( ::String locationName,::lime::utils::ByteArray data,hx::Null< int >  byteArrayOffset);
		...
		virtual Void setProgramConstantsFromByteArray( ::openfl::display3D::Context3DProgramType programType,int firstRegister,int numRegisters,::lime::utils::ByteArray data,int byteArrayOffset);
