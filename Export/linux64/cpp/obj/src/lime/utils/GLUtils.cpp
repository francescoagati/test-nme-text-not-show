...
::lime::graphics::opengl::GLShader GLUtils_obj::compileShader( ::String source,int type){
	...
	HX_STACK_LINE(14)
	::lime::graphics::opengl::GLShader shader = tmp3;		HX_STACK_VAR(shader,"shader");
	HX_STACK_LINE(15)
	{
		HX_STACK_LINE(15)
		...
		HX_STACK_LINE(15)
		::lime::graphics::opengl::GL_obj::lime_gl_shader_source(tmp4,tmp5);
	}
	HX_STACK_LINE(16)
	{
		HX_STACK_LINE(16)
		Dynamic tmp4 = shader->id;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(16)
		::lime::graphics::opengl::GL_obj::lime_gl_compile_shader(tmp4);
	}
	HX_STACK_LINE(18)
	Dynamic tmp4 = shader->id;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(18)
	int tmp5 = ::lime::graphics::opengl::GL_obj::lime_gl_get_shader_parameter(tmp4,(int)35713);		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(18)
	...
	HX_STACK_LINE(30)
	::lime::graphics::opengl::GLShader tmp7 = shader;		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(30)
	return tmp7;
}
...
::lime::graphics::opengl::GLProgram GLUtils_obj::createProgram( ::String vertexSource,::String fragmentSource){
	...
	HX_STACK_LINE(40)
	Dynamic tmp5 = ::lime::graphics::opengl::GL_obj::lime_gl_create_program();		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(40)
	...
	HX_STACK_LINE(41)
	{
		...
		program->attach(tmp7);
		HX_STACK_LINE(41)
		Dynamic tmp8 = program->id;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(41)
		Dynamic tmp9 = vertexShader->id;		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(41)
		::lime::graphics::opengl::GL_obj::lime_gl_attach_shader(tmp8,tmp9);
	}
	HX_STACK_LINE(42)
	{
		HX_STACK_LINE(42)
		...
		Dynamic tmp8 = program->id;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(42)
		Dynamic tmp9 = fragmentShader->id;		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(42)
		::lime::graphics::opengl::GL_obj::lime_gl_attach_shader(tmp8,tmp9);
	}
	HX_STACK_LINE(43)
	{
		HX_STACK_LINE(43)
		Dynamic tmp7 = program->id;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(43)
		::lime::graphics::opengl::GL_obj::lime_gl_link_program(tmp7);
	}
	HX_STACK_LINE(45)
	Dynamic tmp7 = program->id;		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(45)
	int tmp8 = ::lime::graphics::opengl::GL_obj::lime_gl_get_program_parameter(tmp7,(int)35714);		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(45)
