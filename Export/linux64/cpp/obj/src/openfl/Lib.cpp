...
Dynamic Lib_obj::as( Dynamic v,::hx::Class c){
	HX_STACK_FRAME("openfl.Lib","as",0x3965ffb9,"openfl.Lib.as","openfl/Lib.hx",30,0x62fb7c98)
	HX_STACK_ARG(v,"v")
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(35)
...
::openfl::display::MovieClip Lib_obj::attach( ::String name){
	HX_STACK_FRAME("openfl.Lib","attach",0xe350160c,"openfl.Lib.attach","openfl/Lib.hx",41,0x62fb7c98)
...
int Lib_obj::getTimer( ){
	HX_STACK_FRAME("openfl.Lib","getTimer",0xd73d4956,"openfl.Lib.getTimer","openfl/Lib.hx",80,0x62fb7c98)
	HX_STACK_LINE(85)
...
{
		HX_STACK_FRAME("openfl.Lib","getURL",0xa66862c0,"openfl.Lib.getURL","openfl/Lib.hx",91,0x62fb7c98)
...
{
		HX_STACK_FRAME("openfl.Lib","notImplemented",0x6ff873b6,"openfl.Lib.notImplemented","openfl/Lib.hx",108,0x62fb7c98)
		...
		if ((tmp3)){
			...
			HX_STACK_LINE(114)
			Dynamic tmp8 = hx::SourceInfo(HX_HCSTRING("Lib.hx","\xb9","\x80","\x1c","\x19"),114,HX_HCSTRING("openfl.Lib","\x47","\x43","\x57","\x2f"),HX_HCSTRING("notImplemented","\x6f","\x3a","\x1a","\x27"));		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(114)
...
{
		HX_STACK_FRAME("openfl.Lib","trace",0xeba99a1e,"openfl.Lib.trace","openfl/Lib.hx",143,0x62fb7c98)
		HX_STACK_ARG(arg,"arg")
		HX_STACK_LINE(145)
		Dynamic tmp = arg;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(145)
		Dynamic tmp1 = hx::SourceInfo(HX_HCSTRING("Lib.hx","\xb9","\x80","\x1c","\x19"),145,HX_HCSTRING("openfl.Lib","\x47","\x43","\x57","\x2f"),HX_HCSTRING("trace","\x85","\x8e","\x1f","\x16"));		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(145)
...
static hx::StaticInfo sStaticStorageInfo[] = {
	{hx::fsObject /*::lime::app::Application*/ ,(void *) &Lib_obj::application,HX_HCSTRING("application","\x50","\xab","\x3e","\x2a")},
...
struct _Function_0_1{
	inline static ::haxe::ds::StringMap Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/Lib.hx",27,0x62fb7c98)
		{
			HX_STACK_LINE(27)
