...
bool CairoRenderer_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void CairoRenderer_obj::__register()
{
	...
	__mClass->mSetStaticField = &CairoRenderer_obj::__SetStatic;
