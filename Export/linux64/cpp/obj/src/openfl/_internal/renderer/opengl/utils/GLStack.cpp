...
{
HX_STACK_FRAME("openfl._internal.renderer.opengl.utils.GLStack","new",0xd9c5ae34,"openfl._internal.renderer.opengl.utils.GLStack.new","openfl/_internal/renderer/opengl/utils/GraphicsRenderer.hx",1234,0xd295150c)
HX_STACK_THIS(this)
HX_STACK_ARG(gl,"gl")
{
	HX_STACK_LINE(1236)
...
{
		HX_STACK_FRAME("openfl._internal.renderer.opengl.utils.GLStack","reset",0x66cc44a3,"openfl._internal.renderer.opengl.utils.GLStack.reset","openfl/_internal/renderer/opengl/utils/GraphicsRenderer.hx",1246,0xd295150c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1247)
		this->buckets = Array_obj< ::Dynamic >::__new();
		HX_STACK_LINE(1248)
...
{
		HX_STACK_FRAME("openfl._internal.renderer.opengl.utils.GLStack","upload",0x0fd148ad,"openfl._internal.renderer.opengl.utils.GLStack.upload","openfl/_internal/renderer/opengl/utils/GraphicsRenderer.hx",1252,0xd295150c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1252)
...
bool GLStack_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void GLStack_obj::__register()
{
	...
	__mClass->mSetStaticField = &GLStack_obj::__SetStatic;
