...
class HXCPP_CLASS_ATTRIBUTES  ImageBuffer_obj : public hx::Object{
	public:
		...
		ImageBuffer_obj();
		Void __construct(::lime::utils::UInt8Array data,hx::Null< int >  __o_width,hx::Null< int >  __o_height,hx::Null< int >  __o_bitsPerPixel,Dynamic format);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="lime.graphics.ImageBuffer")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		static hx::ObjectPtr< ImageBuffer_obj > __new(::lime::utils::UInt8Array data,hx::Null< int >  __o_width,hx::Null< int >  __o_height,hx::Null< int >  __o_bitsPerPixel,Dynamic format);
