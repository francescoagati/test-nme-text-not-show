...
bool WebAudioContext_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void WebAudioContext_obj::__register()
{
	...
	__mClass->mSetStaticField = &WebAudioContext_obj::__SetStatic;
