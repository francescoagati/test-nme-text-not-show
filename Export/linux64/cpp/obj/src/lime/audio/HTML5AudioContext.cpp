...
bool HTML5AudioContext_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void HTML5AudioContext_obj::__register()
{
	...
	__mClass->mSetStaticField = &HTML5AudioContext_obj::__SetStatic;
