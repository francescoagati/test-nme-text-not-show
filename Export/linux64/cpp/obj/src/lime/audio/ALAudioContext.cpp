...
Void ALAudioContext_obj::bufferData( int buffer,int format,::lime::utils::ByteArray data,int size,int freq){
{
		...
		HX_STACK_LINE(84)
		::lime::utils::ByteArray tmp2 = data;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(84)
...
Array< Float > ALAudioContext_obj::getSourcefv( int source,int param){
	...
	int tmp1 = param;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(413)
	return ::lime::audio::openal::AL_obj::getSourcefv(tmp,tmp1);
}
...
bool ALAudioContext_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void ALAudioContext_obj::__register()
{
	...
	__mClass->mSetStaticField = &ALAudioContext_obj::__SetStatic;
