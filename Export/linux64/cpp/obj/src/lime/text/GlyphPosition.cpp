...
bool GlyphPosition_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void GlyphPosition_obj::__register()
{
	...
	__mClass->mSetStaticField = &GlyphPosition_obj::__SetStatic;
