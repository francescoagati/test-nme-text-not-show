...
{
HX_STACK_FRAME("openfl._internal.renderer.opengl.utils.LineStyle","new",0x3c350e8e,"openfl._internal.renderer.opengl.utils.LineStyle.new","openfl/_internal/renderer/opengl/utils/DrawPath.hx",520,0xf0fd7951)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(521)
	this->width = (int)0;
...
bool LineStyle_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void LineStyle_obj::__register()
{
	...
	__mClass->mSetStaticField = &LineStyle_obj::__SetStatic;
