...
bool FlashRenderContext_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void FlashRenderContext_obj::__register()
{
	...
	__mClass->mSetStaticField = &FlashRenderContext_obj::__SetStatic;
