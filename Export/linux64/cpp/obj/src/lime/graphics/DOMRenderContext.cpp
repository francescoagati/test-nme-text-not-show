...
bool DOMRenderContext_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void DOMRenderContext_obj::__register()
{
	...
	__mClass->mSetStaticField = &DOMRenderContext_obj::__SetStatic;
