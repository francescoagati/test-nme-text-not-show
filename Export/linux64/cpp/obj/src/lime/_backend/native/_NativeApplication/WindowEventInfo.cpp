...
{
HX_STACK_FRAME("lime._backend.native._NativeApplication.WindowEventInfo","new",0xd11afd2d,"lime._backend.native._NativeApplication.WindowEventInfo.new","lime/_backend/native/NativeApplication.hx",719,0xb13849fd)
HX_STACK_THIS(this)
...
{  hx::ObjectPtr< WindowEventInfo_obj > _result_ = new WindowEventInfo_obj();
	_result_->__construct(type,__o_width,__o_height,__o_x,__o_y);
	return _result_;}
...
::lime::_backend::native::_NativeApplication::WindowEventInfo WindowEventInfo_obj::clone( ){
	HX_STACK_FRAME("lime._backend.native._NativeApplication.WindowEventInfo","clone",0x3ae8cd6a,"lime._backend.native._NativeApplication.WindowEventInfo.clone","lime/_backend/native/NativeApplication.hx",730,0xb13849fd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(732)
	...
	HX_STACK_LINE(732)
	::lime::_backend::native::_NativeApplication::WindowEventInfo tmp5 = ::lime::_backend::native::_NativeApplication::WindowEventInfo_obj::__new(tmp,tmp1,tmp2,tmp3,tmp4);		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(732)
	return tmp5;
}
...
bool WindowEventInfo_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void WindowEventInfo_obj::__register()
{
	...
	__mClass->mSetStaticField = &WindowEventInfo_obj::__SetStatic;
