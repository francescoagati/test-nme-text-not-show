...
Void IndexBuffer3D_obj::__construct(::lime::graphics::opengl::GLBuffer glBuffer,int numIndices)
{
...
hx::ObjectPtr< IndexBuffer3D_obj > IndexBuffer3D_obj::__new(::lime::graphics::opengl::GLBuffer glBuffer,int numIndices)
...
Void IndexBuffer3D_obj::uploadFromByteArray( ::lime::utils::ByteArray byteArray,int byteArrayOffset,int startOffset,int count){
{
		...
		HX_STACK_LINE(36)
		{
			...
			HX_STACK_LINE(36)
			::lime::graphics::opengl::GL_obj::lime_gl_bind_buffer((int)34963,tmp2);
		}
		HX_STACK_LINE(38)
		...
		HX_STACK_LINE(40)
		::lime::utils::Int16Array indices;		HX_STACK_VAR(indices,"indices");
		HX_STACK_LINE(55)
		::lime::utils::Int16Array tmp4 = ::lime::utils::Int16Array_obj::__new(byteArray,offset,length);		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(55)
		indices = tmp4;
		HX_STACK_LINE(58)
		{
			HX_STACK_LINE(58)
			::lime::utils::ByteArray tmp5 = indices->getByteBuffer();		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(58)
			int tmp6 = indices->getStart();		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(58)
			int tmp7 = indices->getLength();		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(58)
			::lime::graphics::opengl::GL_obj::lime_gl_buffer_data((int)34963,tmp5,tmp6,tmp7,(int)35044);
		}
	}
return null();
}
...
Void IndexBuffer3D_obj::uploadFromVector( Array< int > data,int startOffset,int count){
{
		...
		::lime::utils::Int16Array indices;		HX_STACK_VAR(indices,"indices");
		HX_STACK_LINE(77)
		::lime::utils::Int16Array tmp = ::lime::utils::Int16Array_obj::__new(data,startOffset,count);		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(77)
		indices = tmp;
		HX_STACK_LINE(80)
		{
			HX_STACK_LINE(80)
			::lime::utils::ByteArray tmp1 = indices->getByteBuffer();		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(80)
			int tmp2 = indices->getStart();		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(80)
			int tmp3 = indices->getLength();		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(80)
			::lime::graphics::opengl::GL_obj::lime_gl_buffer_data((int)34963,tmp1,tmp2,tmp3,(int)35044);
		}
	}
return null();
}
