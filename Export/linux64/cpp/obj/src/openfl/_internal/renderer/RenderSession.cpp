...
bool RenderSession_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void RenderSession_obj::__register()
{
	...
	__mClass->mSetStaticField = &RenderSession_obj::__SetStatic;
