...
{
HX_STACK_FRAME("openfl.text.TextFormatRange","new",0x1e516308,"openfl.text.TextFormatRange.new","openfl/text/TextField.hx",1751,0xccf02094)
HX_STACK_THIS(this)
...
bool TextFormatRange_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void TextFormatRange_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("openfl.text.TextFormatRange","\x16","\x7f","\x99","\xb0");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &hx::Class_obj::GetNoStaticField;
	__mClass->mSetStaticField = &TextFormatRange_obj::__SetStatic;
