...
#define DELEGATE_openfl_IAssetCache \
...
virtual ::openfl::display::BitmapData getBitmapData( ::String id) { return mDelegate->getBitmapData(id);}  \
virtual Dynamic getBitmapData_dyn() { return mDelegate->getBitmapData_dyn();}  \
virtual ::openfl::text::Font getFont( ::String id) { return mDelegate->getFont(id);}  \
virtual Dynamic getFont_dyn() { return mDelegate->getFont_dyn();}  \
virtual ::openfl::media::Sound getSound( ::String id) { return mDelegate->getSound(id);}  \
...
virtual Void setBitmapData( ::String id,::openfl::display::BitmapData bitmapData) { return mDelegate->setBitmapData(id,bitmapData);}  \
virtual Dynamic setBitmapData_dyn() { return mDelegate->setBitmapData_dyn();}  \
virtual Void setFont( ::String id,::openfl::text::Font font) { return mDelegate->setFont(id,font);}  \
virtual Dynamic setFont_dyn() { return mDelegate->setFont_dyn();}  \
virtual Void setSound( ::String id,::openfl::media::Sound sound) { return mDelegate->setSound(id,sound);}  \
