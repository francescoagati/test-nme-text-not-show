...
bool isStatic = __o_isStatic.Default(false);
{
	...
	if ((tmp)){
		HX_STACK_LINE(25)
		::lime::utils::ByteArray tmp1 = ::lime::utils::ByteArray_obj::__new(size);		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(25)
		this->buffer = tmp1;
	}
	HX_STACK_LINE(28)
...
Void VertexArray_obj::bind( ){
{
		...
		HX_STACK_LINE(32)
		{
			...
			HX_STACK_LINE(32)
			int tmp2 = tmp1->ARRAY_BUFFER;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(32)
...
Void VertexArray_obj::unbind( ){
{
		...
		HX_STACK_LINE(36)
		int tmp1 = tmp->ARRAY_BUFFER;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(36)
		...
		HX_STACK_LINE(36)
		::lime::graphics::opengl::GL_obj::lime_gl_bind_buffer(tmp1,tmp3);
	}
return null();
}
...
Void VertexArray_obj::upload( ::lime::utils::ArrayBufferView view){
{
		...
		int tmp1 = tmp->ARRAY_BUFFER;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(40)
		::lime::utils::ByteArray tmp2 = view->getByteBuffer();		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(40)
		int tmp3 = view->getStart();		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(40)
		int tmp4 = view->getLength();		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(40)
		::lime::graphics::opengl::GL_obj::lime_gl_buffer_sub_data(tmp1,(int)0,tmp2,tmp3,tmp4);
	}
return null();
}
...
Void VertexArray_obj::setContext( ::lime::graphics::GLRenderContext gl,::lime::utils::ArrayBufferView view){
{
		...
		{
			HX_STACK_LINE(53)
			::lime::graphics::opengl::GLBuffer tmp3 = this->glBuffer;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(53)
			::lime::graphics::opengl::GLBuffer buffer = tmp3;		HX_STACK_VAR(buffer,"buffer");
			HX_STACK_LINE(53)
			{
				HX_STACK_LINE(53)
				int tmp4 = gl->ARRAY_BUFFER;		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(53)
		...
		{
			HX_STACK_LINE(55)
			int tmp3 = gl->ARRAY_BUFFER;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(55)
			::lime::utils::ByteArray tmp4 = view->getByteBuffer();		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(55)
			int tmp5 = view->getStart();		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(55)
			int tmp6 = view->getLength();		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(55)
			bool tmp7 = this->isStatic;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(55)
...
bool VertexArray_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::lime::utils::ByteArray*/ ,(int)offsetof(VertexArray_obj,buffer),HX_HCSTRING("buffer","\x00","\xbd","\x94","\xd0")},
...
void VertexArray_obj::__register()
{
	...
	__mClass->mSetStaticField = &VertexArray_obj::__SetStatic;
