...
{
		HX_STACK_FRAME("haxe.ds.BalancedTree","set",0xfb547c11,"haxe.ds.BalancedTree.set","/usr/lib/haxe/std/haxe/ds/BalancedTree.hx",50,0xbda098e0)
		HX_STACK_THIS(this)
...
int BalancedTree_obj::compare( Dynamic k1,Dynamic k2){
	HX_STACK_FRAME("haxe.ds.BalancedTree","compare",0x57d05c94,"haxe.ds.BalancedTree.compare","/usr/lib/haxe/std/haxe/ds/BalancedTree.hx",201,0xbda098e0)
	HX_STACK_THIS(this)
	HX_STACK_ARG(k1,"k1")
	HX_STACK_ARG(k2,"k2")
	HX_STACK_LINE(202)
...
bool BalancedTree_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void BalancedTree_obj::__register()
{
	...
	__mClass->mSetStaticField = &BalancedTree_obj::__SetStatic;
