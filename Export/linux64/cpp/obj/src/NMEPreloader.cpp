...
Float NMEPreloader_obj::getHeight( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(66)
	int height = (int)600;		HX_STACK_VAR(height,"height");
	HX_STACK_LINE(68)
...
bool NMEPreloader_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void NMEPreloader_obj::__register()
{
	...
	__mClass->mSetStaticField = &NMEPreloader_obj::__SetStatic;
