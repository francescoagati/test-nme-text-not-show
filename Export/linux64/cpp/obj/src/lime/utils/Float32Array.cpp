...
{
HX_STACK_FRAME("lime.utils.Float32Array","new",0xe309c386,"lime.utils.Float32Array.new","lime/utils/Float32Array.hx",15,0x8d160228)
HX_STACK_THIS(this)
...
int start = __o_start.Default(0);
{
	...
	if ((tmp1)){
		...
		if ((tmp3)){
			HX_STACK_LINE(53)
			Array< Float > floats = ((Array< Float >)(bufferOrArray));		HX_STACK_VAR(floats,"floats");
			HX_STACK_LINE(54)
			...
			HX_STACK_LINE(72)
			bool tmp5 = ::Std_obj::is(tmp4,hx::ClassOf< ::lime::utils::Float32Array >());		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(72)
			if ((tmp5)){
				HX_STACK_LINE(74)
				::lime::utils::Float32Array floats = ((::lime::utils::Float32Array)(bufferOrArray));		HX_STACK_VAR(floats,"floats");
				HX_STACK_LINE(75)
...
int offset = __o_offset.Default(0);
	HX_STACK_FRAME("lime.utils.Float32Array","set",0xe30d8ec8,"lime.utils.Float32Array.set","lime/utils/Float32Array.hx",116,0x8d160228)
	HX_STACK_THIS(this)
	HX_STACK_ARG(bufferOrArray,"bufferOrArray")
	HX_STACK_ARG(offset,"offset")
{
		...
		if ((tmp1)){
			...
			Dynamic tmp2 = bufferOrArray;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(128)
			bool tmp3 = ::Std_obj::is(tmp2,hx::ClassOf< ::lime::utils::Float32Array >());		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(128)
			if ((tmp3)){
				HX_STACK_LINE(130)
				::lime::utils::Float32Array floats = ((::lime::utils::Float32Array)(bufferOrArray));		HX_STACK_VAR(floats,"floats");
...
::lime::utils::Float32Array Float32Array_obj::subarray( int start,Dynamic end){
	...
	HX_STACK_LINE(150)
	::lime::utils::Float32Array tmp5 = ::lime::utils::Float32Array_obj::__new(tmp2,tmp3,tmp4);		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(150)
	return tmp5;
}
...
static hx::StaticInfo sStaticStorageInfo[] = {
	{hx::fsInt,(void *) &Float32Array_obj::BYTES_PER_ELEMENT,HX_HCSTRING("BYTES_PER_ELEMENT","\xa6","\x04","\x1d","\xcc")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
void Float32Array_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("lime.utils.Float32Array","\x94","\x48","\x3c","\x65");
