...
Void Program3D_obj::dispose( ){
{
		...
		HX_STACK_LINE(24)
		::lime::graphics::opengl::GL_obj::lime_gl_delete_program(tmp1);
		HX_STACK_LINE(24)
		program->invalidate();
	}
return null();
...
Void Program3D_obj::upload( ::lime::graphics::opengl::GLShader vertexShader,::lime::graphics::opengl::GLShader fragmentShader){
{
		...
		HX_STACK_LINE(33)
		{
			...
			::lime::graphics::opengl::GLProgram program = tmp;		HX_STACK_VAR(program,"program");
			HX_STACK_LINE(33)
			::lime::graphics::opengl::GLShader tmp1 = vertexShader;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(33)
			program->attach(tmp1);
			HX_STACK_LINE(33)
			...
			HX_STACK_LINE(33)
			::lime::graphics::opengl::GL_obj::lime_gl_attach_shader(tmp2,tmp3);
		}
		HX_STACK_LINE(34)
		{
			HX_STACK_LINE(34)
			...
			::lime::graphics::opengl::GLProgram program = tmp;		HX_STACK_VAR(program,"program");
			HX_STACK_LINE(34)
			::lime::graphics::opengl::GLShader tmp1 = fragmentShader;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(34)
			program->attach(tmp1);
			HX_STACK_LINE(34)
			Dynamic tmp2 = program->id;		HX_STACK_VAR(tmp2,"tmp2");
		...
		HX_STACK_LINE(35)
		{
			...
			HX_STACK_LINE(35)
			::lime::graphics::opengl::GL_obj::lime_gl_link_program(tmp1);
		}
		HX_STACK_LINE(37)
		::lime::graphics::opengl::GLProgram tmp = this->glProgram;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(37)
		Dynamic tmp1 = tmp->id;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(37)
		int tmp2 = ::lime::graphics::opengl::GL_obj::lime_gl_get_program_parameter(tmp1,(int)35714);		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(37)
		bool tmp3 = (tmp2 == (int)0);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(37)
		if ((tmp3)){
			HX_STACK_LINE(39)
			::lime::graphics::opengl::GLProgram tmp4 = this->glProgram;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(39)
			Dynamic tmp5 = tmp4->id;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(39)
			::String tmp6 = ::lime::graphics::opengl::GL_obj::lime_gl_get_program_info_log(tmp5);		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(39)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::lime::graphics::opengl::GLProgram*/ ,(int)offsetof(Program3D_obj,glProgram),HX_HCSTRING("glProgram","\xdf","\xd6","\xb3","\xc1")},
	{ hx::fsUnknown, 0, null()}
};
