...
class HXCPP_CLASS_ATTRIBUTES  GL_obj : public hx::Object{
	...
	public:
		...
		static Void uniform4fv( int location,::lime::utils::Float32Array v);
		static Dynamic uniform4fv_dyn();

		static Void uniform4i( int location,int x,int y,int z,int w);
		static Dynamic uniform4i_dyn();

		static Void uniform4iv( int location,::lime::utils::Int32Array v);
		static Dynamic uniform4iv_dyn();

		static Void uniformMatrix2fv( int location,bool transpose,::lime::utils::Float32Array v);
		static Dynamic uniformMatrix2fv_dyn();

		static Void uniformMatrix3fv( int location,bool transpose,::lime::utils::Float32Array v);
		static Dynamic uniformMatrix3fv_dyn();

		static Void uniformMatrix4fv( int location,bool transpose,::lime::utils::Float32Array v);
		...
		static Void vertexAttrib1fv( int indx,::lime::utils::Float32Array values);
		static Dynamic vertexAttrib1fv_dyn();

		static Void vertexAttrib2f( int indx,Float x,Float y);
		static Dynamic vertexAttrib2f_dyn();

		static Void vertexAttrib2fv( int indx,::lime::utils::Float32Array values);
		...
		static Void vertexAttrib3fv( int indx,::lime::utils::Float32Array values);
		...
		static Void vertexAttrib4fv( int indx,::lime::utils::Float32Array values);
		...
		static Dynamic lime_gl_get_buffer_parameter;
		static Dynamic &lime_gl_get_buffer_parameter_dyn() { return lime_gl_get_buffer_parameter;}
