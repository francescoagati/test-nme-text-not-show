...
Dynamic GLRenderContext_obj::getContextAttributes( ){
	...
	{
		HX_STACK_LINE(789)
		Dynamic tmp1 = ::lime::graphics::opengl::GL_obj::lime_gl_get_context_attributes();		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(789)
		Dynamic base = tmp1;		HX_STACK_VAR(base,"base");
		HX_STACK_LINE(789)
...
bool GLRenderContext_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void GLRenderContext_obj::__register()
{
	...
	__mClass->mSetStaticField = &GLRenderContext_obj::__SetStatic;
