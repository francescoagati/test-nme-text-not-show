...
int Keyboard_obj::convertKeyCode( int key){
	HX_STACK_FRAME("openfl.ui.Keyboard","convertKeyCode",0x8e558484,"openfl.ui.Keyboard.convertKeyCode","openfl/ui/Keyboard.hx",548,0x5fb867bb)
...
bool Keyboard_obj::__GetStatic(const ::String &inName, Dynamic &outValue, hx::PropertyAccess inCallProp)
{
	...
	case 13:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"convertKeyCode") ) { outValue = convertKeyCode_dyn(); return true;  }
	}
	return false;
}
...
static ::String sStaticFields[] = {
	...
	HX_HCSTRING("convertKeyCode","\xb9","\x40","\xf1","\x4e"),
