...
class HXCPP_CLASS_ATTRIBUTES  GLRenderContext_obj : public hx::Object{
	...
	public:
		...
		virtual Void vertexAttrib4fv( int indx,::lime::utils::Float32Array values);
