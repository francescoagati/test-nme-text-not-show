...
{
HX_STACK_FRAME("DocumentClass","new",0x4aeb0a6f,"DocumentClass.new","ApplicationMain.hx",208,0x0780ded5)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(210)
	...
	super::__construct();
	HX_STACK_LINE(212)
	::String tmp1 = ::openfl::events::Event_obj::ADDED_TO_STAGE;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(212)
	::openfl::events::Event tmp2 = ::openfl::events::Event_obj::__new(tmp1,false,false);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(212)
