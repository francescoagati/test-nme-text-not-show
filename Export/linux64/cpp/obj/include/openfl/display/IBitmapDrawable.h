...
virtual Void __renderCairo( ::openfl::_internal::renderer::RenderSession renderSession) { return mDelegate->__renderCairo(renderSession);}  \
virtual Dynamic __renderCairo_dyn() { return mDelegate->__renderCairo_dyn();}  \
virtual Void __renderCairoMask( ::openfl::_internal::renderer::RenderSession renderSession) { return mDelegate->__renderCairoMask(renderSession);}  \
virtual Dynamic __renderCairoMask_dyn() { return mDelegate->__renderCairoMask_dyn();}  \
...
virtual Void __renderCanvasMask( ::openfl::_internal::renderer::RenderSession renderSession) { return mDelegate->__renderCanvasMask(renderSession);}  \
virtual Dynamic __renderCanvasMask_dyn() { return mDelegate->__renderCanvasMask_dyn();}  \
