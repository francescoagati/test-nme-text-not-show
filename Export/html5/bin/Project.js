...
Main.prototype = $extend(openfl_display_Sprite.prototype,{
	...
	,init: function() {
		...
		bitmap.set_y(50);
		bitmap.set_alpha(.5);
		motion_Actuate.tween(bitmap,5,{ alpha : 1, y : -460}).repeat().reflect();
		this.slides = new Slides();
		haxe_Timer.delay(function() {
			var messageFormat = new openfl_text_TextFormat("Verdana",22,16777215,true);
			messageFormat.align = openfl_text_TextFormatAlign.CENTER;
			_g.messageField = new openfl_text_TextField();
			_g.messageField.set_width(800);
			_g.messageField.set_height(200);
			_g.messageField.set_x(-10);
			_g.messageField.set_y(150);
			_g.messageField.set_defaultTextFormat(messageFormat);
			_g.messageField.set_selectable(false);
			_g.messageField.set_text("\n\t\t\t\tHAXE\n\t\t\t\tTHE CROSS PLATFORM TOOLKIT\n\t\t\t");
			_g.setChildIndex(_g.messageField,2);
			_g.addChild(bitmap);
			_g.addChild(_g.messageField);
		},0);
