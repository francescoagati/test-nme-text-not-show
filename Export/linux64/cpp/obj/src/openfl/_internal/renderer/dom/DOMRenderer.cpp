...
{
		HX_STACK_FRAME("openfl._internal.renderer.dom.DOMRenderer","render",0x321c32e6,"openfl._internal.renderer.dom.DOMRenderer.render","openfl/_internal/renderer/dom/DOMRenderer.hx",136,0xc812e2a0)
		HX_STACK_THIS(this)
		HX_STACK_ARG(stage,"stage")
		HX_STACK_LINE(138)
		::lime::graphics::DOMRenderContext tmp = this->element;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(138)
		tmp->style->__FieldRef(HX_HCSTRING("background","\xee","\x93","\x1d","\x26")) = stage->__colorString;
		HX_STACK_LINE(140)
...
{
		HX_STACK_FRAME("openfl._internal.renderer.dom.DOMRenderer","applyStyle",0x6484f073,"openfl._internal.renderer.dom.DOMRenderer.applyStyle","openfl/_internal/renderer/dom/DOMRenderer.hx",63,0xc812e2a0)
...
bool DOMRenderer_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void DOMRenderer_obj::__register()
{
	...
	__mClass->mSetStaticField = &DOMRenderer_obj::__SetStatic;
