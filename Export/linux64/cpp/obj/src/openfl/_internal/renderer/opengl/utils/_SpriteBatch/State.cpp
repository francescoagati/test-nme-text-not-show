...
{
HX_STACK_FRAME("openfl._internal.renderer.opengl.utils._SpriteBatch.State","new",0xda8a05cc,"openfl._internal.renderer.opengl.utils._SpriteBatch.State.new","openfl/_internal/renderer/opengl/utils/SpriteBatch.hx",623,0x8289eb2d)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(628)
...
bool State_obj::equals( ::openfl::_internal::renderer::opengl::utils::_SpriteBatch::State other){
	HX_STACK_FRAME("openfl._internal.renderer.opengl.utils._SpriteBatch.State","equals",0xfb2ee453,"openfl._internal.renderer.opengl.utils._SpriteBatch.State.equals","openfl/_internal/renderer/opengl/utils/SpriteBatch.hx",633,0x8289eb2d)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._internal.renderer.opengl.utils._SpriteBatch.State","destroy",0xbdc18866,"openfl._internal.renderer.opengl.utils._SpriteBatch.State.destroy","openfl/_internal/renderer/opengl/utils/SpriteBatch.hx",643,0x8289eb2d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(644)
		this->texture = null();
		HX_STACK_LINE(645)
