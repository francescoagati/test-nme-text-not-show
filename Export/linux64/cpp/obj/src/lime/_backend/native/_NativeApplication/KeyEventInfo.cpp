...
{
HX_STACK_FRAME("lime._backend.native._NativeApplication.KeyEventInfo","new",0x9d1330f8,"lime._backend.native._NativeApplication.KeyEventInfo.new","lime/_backend/native/NativeApplication.hx",496,0xb13849fd)
HX_STACK_THIS(this)
...
{  hx::ObjectPtr< KeyEventInfo_obj > _result_ = new KeyEventInfo_obj();
	_result_->__construct(type,__o_keyCode,__o_modifier);
	return _result_;}
...
::lime::_backend::native::_NativeApplication::KeyEventInfo KeyEventInfo_obj::clone( ){
	HX_STACK_FRAME("lime._backend.native._NativeApplication.KeyEventInfo","clone",0x1c2dc9f5,"lime._backend.native._NativeApplication.KeyEventInfo.clone","lime/_backend/native/NativeApplication.hx",505,0xb13849fd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(507)
	int tmp = this->type;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(507)
	int tmp1 = this->keyCode;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(507)
	int tmp2 = this->modifier;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(507)
	::lime::_backend::native::_NativeApplication::KeyEventInfo tmp3 = ::lime::_backend::native::_NativeApplication::KeyEventInfo_obj::__new(tmp,tmp1,tmp2);		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(507)
	return tmp3;
}
...
bool KeyEventInfo_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void KeyEventInfo_obj::__register()
{
	...
	__mClass->mSetStaticField = &KeyEventInfo_obj::__SetStatic;
