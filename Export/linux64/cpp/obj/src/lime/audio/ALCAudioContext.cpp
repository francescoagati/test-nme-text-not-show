...
bool ALCAudioContext_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void ALCAudioContext_obj::__register()
{
	...
	__mClass->mSetStaticField = &ALCAudioContext_obj::__SetStatic;
