...
bool GlyphMetrics_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void GlyphMetrics_obj::__register()
{
	...
	__mClass->mSetStaticField = &GlyphMetrics_obj::__SetStatic;
