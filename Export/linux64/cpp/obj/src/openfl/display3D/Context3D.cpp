	...
	HX_STACK_ARG(mask,"mask")
{
		...
		HX_STACK_LINE(103)
		::lime::graphics::opengl::GL_obj::lime_gl_depth_mask(true);
		HX_STACK_LINE(105)
		{
			HX_STACK_LINE(105)
			...
			HX_STACK_LINE(105)
			::lime::graphics::opengl::GL_obj::lime_gl_clear_color(tmp2,tmp3,tmp4,tmp5);
		}
		HX_STACK_LINE(106)
		{
			HX_STACK_LINE(106)
			...
			HX_STACK_LINE(106)
			::lime::graphics::opengl::GL_obj::lime_gl_clear_depth(tmp2);
		}
		HX_STACK_LINE(107)
		{
			HX_STACK_LINE(107)
			...
			HX_STACK_LINE(107)
			::lime::graphics::opengl::GL_obj::lime_gl_clear_stencil(tmp2);
		}
		HX_STACK_LINE(109)
		{
			HX_STACK_LINE(109)
			...
			HX_STACK_LINE(109)
			::lime::graphics::opengl::GL_obj::lime_gl_clear(tmp2);
		}
	}
return null();
}
	...
	HX_STACK_ARG(enableDepthAndStencil,"enableDepthAndStencil")
{
		...
		if ((tmp)){
			HX_STACK_LINE(119)
			::lime::graphics::opengl::GL_obj::lime_gl_enable((int)2929);
			HX_STACK_LINE(120)
			::lime::graphics::opengl::GL_obj::lime_gl_enable((int)2960);
		}
		HX_STACK_LINE(125)
		...
		HX_STACK_LINE(129)
		{
			...
			HX_STACK_LINE(129)
			::lime::graphics::opengl::GL_obj::lime_gl_viewport(tmp22,tmp23,tmp24,tmp25);
		}
	}
return null();
}
...
Void Context3D_obj::dispose( ){
{
		...
		if ((tmp1)){
			HX_STACK_LINE(229)
			{
				...
				HX_STACK_LINE(229)
				::lime::graphics::opengl::GL_obj::lime_gl_delete_framebuffer(tmp3);
				HX_STACK_LINE(229)
		...
		if ((tmp3)){
			HX_STACK_LINE(236)
			{
				...
				HX_STACK_LINE(236)
				Dynamic tmp5 = renderbuffer->id;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(236)
				::lime::graphics::opengl::GL_obj::lime_gl_delete_render_buffer(tmp5);
				HX_STACK_LINE(236)
	...
	HX_STACK_ARG(numTriangles,"numTriangles")
{
		...
		HX_STACK_LINE(255)
		int tmp2 = ::lime::graphics::opengl::GL_obj::lime_gl_get_uniform_location(tmp1,HX_HCSTRING("yflip","\xa6","\x43","\x3a","\xef"));		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(255)
		int location = tmp2;		HX_STACK_VAR(location,"location");
		HX_STACK_LINE(256)
		{
			HX_STACK_LINE(256)
			int tmp3 = location;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(256)
			Float tmp4 = this->_yFlip;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(256)
			::lime::graphics::opengl::GL_obj::lime_gl_uniform1f(tmp3,tmp4);
		}
		HX_STACK_LINE(258)
		...
		HX_STACK_LINE(278)
		{
			...
			HX_STACK_LINE(278)
			::lime::graphics::opengl::GL_obj::lime_gl_bind_buffer((int)34963,tmp8);
		}
		HX_STACK_LINE(279)
		{
			HX_STACK_LINE(279)
			...
			HX_STACK_LINE(279)
			::lime::graphics::opengl::GL_obj::lime_gl_draw_elements((int)4,tmp7,(int)5123,tmp8);
		}
	}
return null();
}
...
Void Context3D_obj::present( ){
{
		...
		HX_STACK_LINE(289)
		{
			...
			HX_STACK_LINE(289)
			::lime::graphics::opengl::GL_obj::lime_gl_bind_buffer((int)34962,tmp1);
		}
		HX_STACK_LINE(290)
		::lime::graphics::opengl::GL_obj::lime_gl_disable((int)2884);
		HX_STACK_LINE(292)
		::lime::graphics::opengl::GLFramebuffer tmp = this->framebuffer;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(292)
		bool tmp1 = (tmp != null());		HX_STACK_VAR(tmp1,"tmp1");
		...
		if ((tmp1)){
			...
			HX_STACK_LINE(294)
			::lime::graphics::opengl::GL_obj::lime_gl_bind_framebuffer((int)36160,tmp3);
		}
		HX_STACK_LINE(298)
		::lime::graphics::opengl::GLRenderbuffer tmp2 = this->renderbuffer;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(298)
		...
		if ((tmp3)){
			...
			HX_STACK_LINE(300)
			::lime::graphics::opengl::GL_obj::lime_gl_bind_renderbuffer((int)36161,tmp5);
		}
	}
return null();
}
...
Void Context3D_obj::setCulling( int triangleFaceToCull){
{
		...
		if ((tmp)){
			...
			HX_STACK_LINE(345)
			::lime::graphics::opengl::GL_obj::lime_gl_enable((int)2884);
			HX_STACK_LINE(347)
			...
			switch( (int)(tmp1)){
				case (int)1029: {
					HX_STACK_LINE(349)
					::lime::graphics::opengl::GL_obj::lime_gl_cull_face((int)1029);
				}
				;break;
				case (int)1028: {
					HX_STACK_LINE(350)
					::lime::graphics::opengl::GL_obj::lime_gl_cull_face((int)1028);
				}
				;break;
				case (int)1032: {
					HX_STACK_LINE(351)
					::lime::graphics::opengl::GL_obj::lime_gl_cull_face((int)1032);
				}
				;break;
				default: {
					HX_STACK_LINE(352)
	...
	HX_STACK_ARG(byteArrayOffset,"byteArrayOffset")
{
		...
		HX_STACK_LINE(397)
		int tmp3 = ::lime::graphics::opengl::GL_obj::lime_gl_get_uniform_location(tmp1,tmp2);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(397)
		...
		HX_STACK_LINE(398)
		{
			...
			HX_STACK_LINE(398)
			::lime::graphics::opengl::GL_obj::lime_gl_uniform4f(tmp8,tmp9,tmp10,tmp11,tmp12);
		}
	}
return null();
}
	...
	HX_STACK_ARG(transposedMatrix,"transposedMatrix")
{
		...
		{
			HX_STACK_LINE(406)
			::lime::utils::Float32Array tmp4 = ::lime::utils::Float32Array_obj::__new(matrix->rawData,null(),null());		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(406)
			::lime::utils::Float32Array v = tmp4;		HX_STACK_VAR(v,"v");
			HX_STACK_LINE(406)
			...
			HX_STACK_LINE(406)
			::lime::graphics::opengl::GL_obj::lime_gl_uniform_matrix(tmp5,tmp7,tmp8,(int)4);
		}
	}
return null();
}
	...
	HX_STACK_ARG(startIndex,"startIndex")
{
		...
		HX_STACK_LINE(414)
		{
			...
			HX_STACK_LINE(414)
			::lime::graphics::opengl::GL_obj::lime_gl_uniform4f(tmp4,tmp5,tmp7,tmp9,tmp11);
		}
	}
return null();
}
...
Void Context3D_obj::setGLSLTextureAt( ::String locationName,::openfl::display3D::textures::TextureBase texture,int textureIndex){
{
		...
		switch( (int)(tmp)){
			case (int)0: {
				HX_STACK_LINE(423)
				::lime::graphics::opengl::GL_obj::lime_gl_active_texture((int)33984);
			}
			;break;
			case (int)1: {
				HX_STACK_LINE(424)
				::lime::graphics::opengl::GL_obj::lime_gl_active_texture((int)33985);
			}
			;break;
			case (int)2: {
				HX_STACK_LINE(425)
				::lime::graphics::opengl::GL_obj::lime_gl_active_texture((int)33986);
			}
			;break;
			case (int)3: {
				HX_STACK_LINE(426)
				::lime::graphics::opengl::GL_obj::lime_gl_active_texture((int)33987);
			}
			;break;
			case (int)4: {
				HX_STACK_LINE(427)
				::lime::graphics::opengl::GL_obj::lime_gl_active_texture((int)33988);
			}
			;break;
			case (int)5: {
				HX_STACK_LINE(428)
				::lime::graphics::opengl::GL_obj::lime_gl_active_texture((int)33989);
			}
			;break;
			case (int)6: {
				HX_STACK_LINE(429)
				::lime::graphics::opengl::GL_obj::lime_gl_active_texture((int)33990);
			}
			;break;
			case (int)7: {
				HX_STACK_LINE(430)
				::lime::graphics::opengl::GL_obj::lime_gl_active_texture((int)33991);
			}
			;break;
			default: {
				HX_STACK_LINE(432)
		...
		HX_STACK_LINE(444)
		int tmp5 = ::lime::graphics::opengl::GL_obj::lime_gl_get_uniform_location(tmp3,tmp4);		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(444)
		...
		if ((tmp7)){
			HX_STACK_LINE(448)
			{
				...
				HX_STACK_LINE(448)
				::lime::graphics::opengl::GLTexture tmp9 = tmp8->glTexture;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(448)
				::lime::graphics::opengl::GLTexture texture1 = tmp9;		HX_STACK_VAR(texture1,"texture1");
				HX_STACK_LINE(448)
				...
				HX_STACK_LINE(448)
				::lime::graphics::opengl::GL_obj::lime_gl_bind_texture((int)3553,tmp11);
			}
			HX_STACK_LINE(449)
			{
				HX_STACK_LINE(449)
				...
				HX_STACK_LINE(449)
				::lime::graphics::opengl::GL_obj::lime_gl_uniform1i(tmp8,tmp9);
			}
		}
		else{
			HX_STACK_LINE(451)
			...
			if ((tmp9)){
				HX_STACK_LINE(453)
				{
					...
					HX_STACK_LINE(453)
					::lime::graphics::opengl::GLTexture tmp11 = tmp10->glTexture;		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(453)
					::lime::graphics::opengl::GLTexture texture1 = tmp11;		HX_STACK_VAR(texture1,"texture1");
					HX_STACK_LINE(453)
					...
					HX_STACK_LINE(453)
					::lime::graphics::opengl::GL_obj::lime_gl_bind_texture((int)3553,tmp13);
				}
				HX_STACK_LINE(454)
				{
					HX_STACK_LINE(454)
					...
					HX_STACK_LINE(454)
					::lime::graphics::opengl::GL_obj::lime_gl_uniform1i(tmp10,tmp11);
				}
			}
			else{
				HX_STACK_LINE(456)
				...
				if ((tmp11)){
					HX_STACK_LINE(458)
					{
						...
						HX_STACK_LINE(458)
						::lime::graphics::opengl::GLTexture tmp13 = tmp12->glTexture;		HX_STACK_VAR(tmp13,"tmp13");
						HX_STACK_LINE(458)
						::lime::graphics::opengl::GLTexture texture1 = tmp13;		HX_STACK_VAR(texture1,"texture1");
						HX_STACK_LINE(458)
						...
						HX_STACK_LINE(458)
						::lime::graphics::opengl::GL_obj::lime_gl_bind_texture((int)34067,tmp15);
					}
					HX_STACK_LINE(459)
					{
						HX_STACK_LINE(459)
						...
						HX_STACK_LINE(459)
						::lime::graphics::opengl::GL_obj::lime_gl_uniform1i(tmp12,tmp13);
					}
				}
				else{
					HX_STACK_LINE(463)
	...
	HX_STACK_ARG(format,"format")
{
		...
		if ((tmp2)){
			...
			HX_STACK_LINE(484)
			tmp3 = ::lime::graphics::opengl::GL_obj::lime_gl_get_attrib_location(tmp5,tmp6);
		}
		else{
			HX_STACK_LINE(484)
			tmp3 = (int)-1;
		...
		if ((tmp4)){
			...
			if ((tmp5)){
				HX_STACK_LINE(490)
				{
					...
					HX_STACK_LINE(490)
					::lime::graphics::opengl::GL_obj::lime_gl_disable_vertex_attrib_array(tmp6);
				}
				HX_STACK_LINE(493)
				{
					HX_STACK_LINE(493)
					...
					HX_STACK_LINE(493)
					::lime::graphics::opengl::GL_obj::lime_gl_bind_buffer((int)34962,tmp7);
				}
			}
			HX_STACK_LINE(498)
			return null();
		...
		HX_STACK_LINE(502)
		{
			...
			HX_STACK_LINE(502)
			::lime::graphics::opengl::GL_obj::lime_gl_bind_buffer((int)34962,tmp6);
		}
		HX_STACK_LINE(504)
		...
		HX_STACK_LINE(544)
		{
			...
			int tmp6 = location;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(544)
			::lime::graphics::opengl::GL_obj::lime_gl_enable_vertex_attrib_array(tmp6);
		}
		HX_STACK_LINE(545)
		{
			HX_STACK_LINE(545)
			...
			HX_STACK_LINE(545)
			::lime::graphics::opengl::GL_obj::lime_gl_vertex_attrib_pointer(tmp6,tmp7,tmp8,false,tmp9,tmp10);
		}
	}
return null();
}
...
Void Context3D_obj::setProgram( ::openfl::display3D::Program3D program3D){
{
		...
		HX_STACK_LINE(560)
		{
			...
			HX_STACK_LINE(560)
			::lime::graphics::opengl::GL_obj::lime_gl_use_program(tmp2);
		}
		HX_STACK_LINE(561)
...
Void Context3D_obj::setRenderToBackBuffer( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(627)
		::lime::graphics::opengl::GL_obj::lime_gl_disable((int)2929);
		HX_STACK_LINE(628)
		::lime::graphics::opengl::GL_obj::lime_gl_disable((int)2960);
		HX_STACK_LINE(629)
		::lime::graphics::opengl::GL_obj::lime_gl_disable((int)3089);
		HX_STACK_LINE(631)
		::lime::graphics::opengl::GLFramebuffer tmp = this->framebuffer;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(631)
		bool tmp1 = (tmp != null());		HX_STACK_VAR(tmp1,"tmp1");
		...
		HX_STACK_LINE(643)
		{
			...
			HX_STACK_LINE(643)
			::lime::graphics::opengl::GL_obj::lime_gl_viewport(tmp16,tmp17,tmp18,tmp19);
		}
	}
return null();
}
	...
	HX_STACK_ARG(surfaceSelector,"surfaceSelector")
{
		...
		if ((tmp1)){
			...
			HX_STACK_LINE(654)
			Dynamic tmp3 = ::lime::graphics::opengl::GL_obj::lime_gl_create_framebuffer();		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(654)
			::lime::graphics::opengl::GLFramebuffer tmp4 = ::lime::graphics::opengl::GLFramebuffer_obj::__new(tmp2,tmp3);		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(654)
		...
		HX_STACK_LINE(658)
		{
			...
			HX_STACK_LINE(658)
			::lime::graphics::opengl::GL_obj::lime_gl_bind_framebuffer((int)36160,tmp4);
		}
		HX_STACK_LINE(660)
		::lime::graphics::opengl::GLRenderbuffer tmp2 = this->renderbuffer;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(660)
		...
		if ((tmp3)){
			...
			HX_STACK_LINE(662)
			Dynamic tmp5 = ::lime::graphics::opengl::GL_obj::lime_gl_create_render_buffer();		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(662)
			::lime::graphics::opengl::GLRenderbuffer tmp6 = ::lime::graphics::opengl::GLRenderbuffer_obj::__new(tmp4,tmp5);		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(662)
		...
		HX_STACK_LINE(666)
		{
			...
			HX_STACK_LINE(666)
			::lime::graphics::opengl::GL_obj::lime_gl_bind_renderbuffer((int)36161,tmp6);
		}
		HX_STACK_LINE(670)
		{
			HX_STACK_LINE(670)
			...
			HX_STACK_LINE(670)
			::lime::graphics::opengl::GL_obj::lime_gl_renderbuffer_storage((int)36161,(int)6408,tmp4,tmp5);
		}
		HX_STACK_LINE(672)
		{
			HX_STACK_LINE(672)
			...
			HX_STACK_LINE(672)
			::lime::graphics::opengl::GL_obj::lime_gl_framebuffer_texture2D((int)36160,(int)36064,(int)3553,tmp4,(int)0);
		}
		HX_STACK_LINE(674)
		{
			HX_STACK_LINE(674)
			...
			int tmp5 = texture->height;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(674)
			::lime::graphics::opengl::GL_obj::lime_gl_renderbuffer_storage((int)36161,(int)34041,tmp4,tmp5);
		}
		HX_STACK_LINE(675)
		{
			HX_STACK_LINE(675)
			...
			HX_STACK_LINE(675)
			::lime::graphics::opengl::GL_obj::lime_gl_framebuffer_renderbuffer((int)36160,(int)33306,(int)36161,tmp5);
		}
		HX_STACK_LINE(677)
		...
		HX_STACK_LINE(683)
		{
			...
			HX_STACK_LINE(683)
			::lime::graphics::opengl::GL_obj::lime_gl_bind_texture((int)3553,tmp6);
		}
		HX_STACK_LINE(684)
		{
			HX_STACK_LINE(684)
			...
			HX_STACK_LINE(684)
			::lime::graphics::opengl::GL_obj::lime_gl_tex_image_2d((int)3553,(int)0,(int)6408,tmp5,tmp6,(int)0,(int)6408,(int)5121,tmp8,tmp10);
		}
		HX_STACK_LINE(685)
		::lime::graphics::opengl::GL_obj::lime_gl_tex_parameteri((int)3553,(int)10240,(int)9729);
		HX_STACK_LINE(686)
		::lime::graphics::opengl::GL_obj::lime_gl_tex_parameteri((int)3553,(int)10241,(int)9985);
		HX_STACK_LINE(688)
		{
			HX_STACK_LINE(688)
			int tmp5 = texture->width;		HX_STACK_VAR(tmp5,"tmp5");
			...
			int tmp6 = texture->height;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(688)
			::lime::graphics::opengl::GL_obj::lime_gl_viewport((int)0,(int)0,tmp5,tmp6);
		}
	}
return null();
}
...
Void Context3D_obj::setScissorRectangle( ::openfl::geom::Rectangle rectangle){
{
		...
		HX_STACK_LINE(722)
		::lime::graphics::opengl::GL_obj::lime_gl_enable((int)3089);
		HX_STACK_LINE(723)
		{
			HX_STACK_LINE(723)
			...
			HX_STACK_LINE(723)
			::lime::graphics::opengl::GL_obj::lime_gl_scissor(tmp9,tmp10,tmp11,tmp12);
		}
	}
return null();
}
...
Void Context3D_obj::setTextureParameters( ::openfl::display3D::textures::TextureBase texture,::openfl::display3D::Context3DWrapMode wrap,::openfl::display3D::Context3DTextureFilter filter,::openfl::display3D::Context3DMipFilter mipfilter){
{
		...
		if ((tmp1)){
			HX_STACK_LINE(766)
			Dynamic ext = null();		HX_STACK_VAR(ext,"ext");
			HX_STACK_LINE(767)
			bool tmp2 = (ext == null());		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(767)
			if ((tmp2)){
				HX_STACK_LINE(767)
				ext = null();
			...
			HX_STACK_LINE(768)
			bool tmp3 = (ext == null());		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(768)
			if ((tmp3)){
				HX_STACK_LINE(768)
				ext = null();
			...
			HX_STACK_LINE(769)
			bool tmp4 = (ext != null());		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(769)
			::openfl::display3D::Context3D_obj::supportsAnisotropy = tmp4;
			HX_STACK_LINE(773)
			...
			HX_STACK_LINE(775)
			{
				...
				HX_STACK_LINE(775)
				{
					...
					HX_STACK_LINE(775)
					int _int = tmp7;		HX_STACK_VAR(_int,"int");
					HX_STACK_LINE(775)
				...
				HX_STACK_LINE(775)
				::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)3553,tmp5,tmp6);
			}
			HX_STACK_LINE(776)
			int tmp5 = ::openfl::display3D::Context3D_obj::TEXTURE_MAX_ANISOTROPY_EXT;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(776)
			int tmp6 = ::lime::graphics::opengl::GL_obj::lime_gl_get_tex_parameter((int)3553,tmp5);		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(776)
			::openfl::display3D::Context3D_obj::maxSupportedAnisotropy = tmp6;
		}
		HX_STACK_LINE(780)
		::openfl::display3D::textures::TextureBase tmp2 = texture;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(780)
		...
		if ((tmp3)){
			HX_STACK_LINE(783)
			{
				...
				HX_STACK_LINE(783)
				::lime::graphics::opengl::GLTexture tmp5 = tmp4->glTexture;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(783)
				::lime::graphics::opengl::GLTexture texture1 = tmp5;		HX_STACK_VAR(texture1,"texture1");
				HX_STACK_LINE(783)
				...
				HX_STACK_LINE(783)
				::lime::graphics::opengl::GL_obj::lime_gl_bind_texture((int)3553,tmp7);
			}
			HX_STACK_LINE(786)
			switch( (int)(wrap->__Index())){
				...
				case (int)1: {
					HX_STACK_LINE(795)
					::lime::graphics::opengl::GL_obj::lime_gl_tex_parameteri((int)3553,(int)10242,(int)10497);
					HX_STACK_LINE(796)
					::lime::graphics::opengl::GL_obj::lime_gl_tex_parameteri((int)3553,(int)10243,(int)10497);
				}
				;break;
			}
			HX_STACK_LINE(803)
			switch( (int)(filter->__Index())){
				case (int)4: {
					...
					if ((tmp4)){
						...
						int tmp5 = ::openfl::display3D::Context3D_obj::TEXTURE_MAX_ANISOTROPY_EXT;		HX_STACK_VAR(tmp5,"tmp5");
						HX_STACK_LINE(809)
						::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)3553,tmp5,(int)1);
					}
				}
				;break;
				case (int)5: {
				...
				case (int)0: {
					...
					if ((tmp4)){
						...
						HX_STACK_LINE(820)
						::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)3553,tmp5,tmp7);
					}
				}
				;break;
				case (int)1: {
			...
			switch( (int)(mipfilter->__Index())){
				case (int)0: {
					HX_STACK_LINE(843)
					::lime::graphics::opengl::GL_obj::lime_gl_generate_mipmap((int)3553);
					HX_STACK_LINE(844)
					::lime::graphics::opengl::GL_obj::lime_gl_tex_parameteri((int)3553,(int)10241,(int)9987);
				}
				;break;
				case (int)1: {
					HX_STACK_LINE(848)
					::lime::graphics::opengl::GL_obj::lime_gl_generate_mipmap((int)3553);
					HX_STACK_LINE(849)
					::lime::graphics::opengl::GL_obj::lime_gl_tex_parameteri((int)3553,(int)10241,(int)9984);
				}
				;break;
				case (int)2: {
					HX_STACK_LINE(853)
					::lime::graphics::opengl::GL_obj::lime_gl_tex_parameteri((int)3553,(int)10241,(int)9729);
				}
				;break;
			}
		}
			...
			if ((tmp5)){
				HX_STACK_LINE(860)
				{
					...
					HX_STACK_LINE(860)
					::lime::graphics::opengl::GLTexture tmp7 = tmp6->glTexture;		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(860)
					::lime::graphics::opengl::GLTexture texture1 = tmp7;		HX_STACK_VAR(texture1,"texture1");
					HX_STACK_LINE(860)
					...
					HX_STACK_LINE(860)
					::lime::graphics::opengl::GL_obj::lime_gl_bind_texture((int)3553,tmp9);
				}
				HX_STACK_LINE(863)
				::lime::graphics::opengl::GL_obj::lime_gl_tex_parameteri((int)3553,(int)10242,(int)33071);
				HX_STACK_LINE(864)
				...
				switch( (int)(filter->__Index())){
					case (int)4: {
						...
						if ((tmp6)){
							...
							HX_STACK_LINE(872)
							::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)3553,tmp7,(int)1);
						}
					}
					;break;
					case (int)5: {
					...
					case (int)0: {
						...
						if ((tmp6)){
							...
							HX_STACK_LINE(883)
							::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)3553,tmp7,tmp9);
						}
					}
					;break;
					case (int)1: {
				...
				if ((tmp7)){
					HX_STACK_LINE(907)
					{
						...
						HX_STACK_LINE(907)
						::lime::graphics::opengl::GL_obj::lime_gl_bind_texture((int)34067,tmp11);
					}
					HX_STACK_LINE(910)
					switch( (int)(wrap->__Index())){
						case (int)0: {
							HX_STACK_LINE(914)
							::lime::graphics::opengl::GL_obj::lime_gl_tex_parameteri((int)34067,(int)10242,(int)33071);
							HX_STACK_LINE(915)
							::lime::graphics::opengl::GL_obj::lime_gl_tex_parameteri((int)34067,(int)10243,(int)33071);
						}
						;break;
						case (int)1: {
							HX_STACK_LINE(919)
							::lime::graphics::opengl::GL_obj::lime_gl_tex_parameteri((int)34067,(int)10242,(int)10497);
							HX_STACK_LINE(920)
							::lime::graphics::opengl::GL_obj::lime_gl_tex_parameteri((int)34067,(int)10243,(int)10497);
						}
						;break;
					}
					HX_STACK_LINE(924)
					switch( (int)(filter->__Index())){
						case (int)4: {
							HX_STACK_LINE(928)
							::lime::graphics::opengl::GL_obj::lime_gl_tex_parameteri((int)34067,(int)10240,(int)9729);
							HX_STACK_LINE(929)
							...
							if ((tmp8)){
								...
								HX_STACK_LINE(930)
								::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)34067,tmp9,(int)1);
							}
						}
						;break;
						case (int)5: {
							HX_STACK_LINE(934)
							::lime::graphics::opengl::GL_obj::lime_gl_tex_parameteri((int)34067,(int)10240,(int)9728);
							HX_STACK_LINE(935)
							bool tmp8 = ::openfl::display3D::Context3D_obj::supportsAnisotropy;		HX_STACK_VAR(tmp8,"tmp8");
							HX_STACK_LINE(935)
							if ((tmp8)){
						...
						case (int)0: {
							...
							if ((tmp8)){
								...
								HX_STACK_LINE(941)
								::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)34067,tmp9,tmp11);
							}
						}
						;break;
						case (int)1: {
					...
					switch( (int)(mipfilter->__Index())){
						case (int)0: {
							HX_STACK_LINE(964)
							::lime::graphics::opengl::GL_obj::lime_gl_tex_parameteri((int)34067,(int)10241,(int)9987);
						}
						;break;
						case (int)1: {
							HX_STACK_LINE(968)
							::lime::graphics::opengl::GL_obj::lime_gl_tex_parameteri((int)34067,(int)10241,(int)9984);
						}
						;break;
						case (int)2: {
							HX_STACK_LINE(972)
							::lime::graphics::opengl::GL_obj::lime_gl_tex_parameteri((int)34067,(int)10241,(int)9729);
						}
						;break;
					}
				}
...
Void Context3D_obj::__updateBlendStatus( ){
{
		...
		if ((tmp)){
			HX_STACK_LINE(1016)
			::lime::graphics::opengl::GL_obj::lime_gl_enable((int)3042);
			HX_STACK_LINE(1017)
			::lime::graphics::opengl::GL_obj::lime_gl_blend_equation((int)32774);
			HX_STACK_LINE(1018)
			{
				HX_STACK_LINE(1018)
				...
				HX_STACK_LINE(1018)
				::lime::graphics::opengl::GL_obj::lime_gl_blend_func(tmp1,tmp2);
			}
		}
		else{
			HX_STACK_LINE(1022)
			::lime::graphics::opengl::GL_obj::lime_gl_disable((int)3042);
		}
	}
return null();
}
