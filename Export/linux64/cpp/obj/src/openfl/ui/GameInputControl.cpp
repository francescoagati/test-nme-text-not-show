...
bool GameInputControl_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void GameInputControl_obj::__register()
{
	...
	__mClass->mSetStaticField = &GameInputControl_obj::__SetStatic;
