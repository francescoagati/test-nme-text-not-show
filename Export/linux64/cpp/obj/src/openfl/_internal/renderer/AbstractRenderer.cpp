...
bool AbstractRenderer_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void AbstractRenderer_obj::__register()
{
	...
	__mClass->mSetStaticField = &AbstractRenderer_obj::__SetStatic;
