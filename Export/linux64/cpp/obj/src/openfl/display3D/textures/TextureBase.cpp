...
Void TextureBase_obj::__construct(::lime::graphics::opengl::GLTexture glTexture,hx::Null< int >  __o_width,hx::Null< int >  __o_height)
{
...
hx::ObjectPtr< TextureBase_obj > TextureBase_obj::__new(::lime::graphics::opengl::GLTexture glTexture,hx::Null< int >  __o_width,hx::Null< int >  __o_height)
...
Dynamic TextureBase_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"glTexture") ) { glTexture=inValue.Cast< ::lime::graphics::opengl::GLTexture >(); return inValue; }
		break;
	case 11:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::lime::graphics::opengl::GLFramebuffer*/ ,(int)offsetof(TextureBase_obj,frameBuffer),HX_HCSTRING("frameBuffer","\x0d","\x89","\xdc","\xae")},
	{hx::fsObject /*::lime::graphics::opengl::GLTexture*/ ,(int)offsetof(TextureBase_obj,glTexture),HX_HCSTRING("glTexture","\x36","\x55","\x9b","\x6c")},
