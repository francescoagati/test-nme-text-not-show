...
{
HX_STACK_FRAME("lime.utils.UInt16Array","new",0xe3b8d5b6,"lime.utils.UInt16Array.new","lime/utils/UInt16Array.hx",15,0x124ad8bc)
HX_STACK_THIS(this)
...
int start = __o_start.Default(0);
{
	...
	if ((tmp1)){
		...
		if ((tmp3)){
			...
			HX_STACK_LINE(72)
			bool tmp5 = ::Std_obj::is(tmp4,hx::ClassOf< ::lime::utils::UInt16Array >());		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(72)
			if ((tmp5)){
				HX_STACK_LINE(74)
				::lime::utils::UInt16Array ints = ((::lime::utils::UInt16Array)(bufferOrArray));		HX_STACK_VAR(ints,"ints");
				HX_STACK_LINE(75)
...
int offset = __o_offset.Default(0);
	HX_STACK_FRAME("lime.utils.UInt16Array","set",0xe3bca0f8,"lime.utils.UInt16Array.set","lime/utils/UInt16Array.hx",116,0x124ad8bc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(bufferOrArray,"bufferOrArray")
	HX_STACK_ARG(offset,"offset")
{
		...
		if ((tmp1)){
			...
			Dynamic tmp2 = bufferOrArray;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(128)
			bool tmp3 = ::Std_obj::is(tmp2,hx::ClassOf< ::lime::utils::UInt16Array >());		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(128)
			if ((tmp3)){
				HX_STACK_LINE(130)
				::lime::utils::UInt16Array ints = ((::lime::utils::UInt16Array)(bufferOrArray));		HX_STACK_VAR(ints,"ints");
...
::lime::utils::UInt16Array UInt16Array_obj::subarray( int start,Dynamic end){
	...
	HX_STACK_LINE(150)
	::lime::utils::UInt16Array tmp5 = ::lime::utils::UInt16Array_obj::__new(tmp2,tmp3,tmp4);		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(150)
	return tmp5;
}
...
int UInt16Array_obj::__get( int index){
	...
	HX_STACK_LINE(155)
	int tmp = ::__hxcpp_memory_get_ui16(this->bytes,(((int(index) << int((int)1))) + this->byteOffset));		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(155)
...
Dynamic UInt16Array_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
...
bool UInt16Array_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsInt,(int)offsetof(UInt16Array_obj,length),HX_HCSTRING("length","\xe6","\x94","\x07","\x9f")},
	{ hx::fsUnknown, 0, null()}
};
static hx::StaticInfo sStaticStorageInfo[] = {
	{hx::fsInt,(void *) &UInt16Array_obj::BYTES_PER_ELEMENT,HX_HCSTRING("BYTES_PER_ELEMENT","\xa6","\x04","\x1d","\xcc")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
void UInt16Array_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("lime.utils.UInt16Array","\xc4","\x82","\x0a","\x06");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &hx::Class_obj::GetNoStaticField;
	__mClass->mSetStaticField = &UInt16Array_obj::__SetStatic;
