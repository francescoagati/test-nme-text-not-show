...
bool CanvasRenderContext_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void CanvasRenderContext_obj::__register()
{
	...
	__mClass->mSetStaticField = &CanvasRenderContext_obj::__SetStatic;
