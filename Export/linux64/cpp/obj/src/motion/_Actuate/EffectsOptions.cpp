...
bool EffectsOptions_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void EffectsOptions_obj::__register()
{
	...
	__mClass->mSetStaticField = &EffectsOptions_obj::__SetStatic;
